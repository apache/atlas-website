...
`,W=({repository:e,...t})=>r.createElement(F,t,r.createElement(N.a,{href:"https://github.com/apache/atlas/fork","data-size":"large","aria-label":"Fork apache/atlas on GitHub"},"Fork"),r.createElement(N.a,{href:"https://github.com/apache/atlas/archive/master.zip","data-size":"large","aria-label":"Download apache/atlas on GitHub"},"Download"),r.createElement(N.a,{href:"https://github.com/apache/atlas","data-size":"large","aria-label":"Star apache/atlas on GitHub"},"Star"));var q=o("./node_modules/lodash/fp/unionBy.js"),U=o.n(q),G=o("./node_modules/lodash/fp/get.js"),V=o.n(G),K=o("./node_modules/facepaint/dist/index.es.js");const J=420,Q=920,Z=1024,X=1120,Y=Object(K.a)([`@media(min-width: ${J}px)`,`@media(min-width: ${Q}px)`,`@media(min-width: ${X}px)`]),ee=P("colors.sidebarPrimary"),te=P("colors.primary"),oe=j.d.div`
  position: relative;
  display: flex;
...
`;_e.defaultProps=Le;const Re=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,i=Se.checkMenuIsOPen(e),s=i,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,d=e=>{e.preventDefault(),n(t)},c={handleActiveMenu:n,activeMenu:a};let p=r.createElement(ze,null,r.createElement(Ee,Te({item:t},u&&{onClick:d}),` ${t.name} `,l&&r.createElement(_e,{opened:s},r.createElement(de.a,{size:15}))),l&&r.createElement(Me,{opened:s},t.menu&&t.menu.map(e=>r.createElement(Me,{opened:s,key:e.name},r.createElement(He,Te({item:e},c))))));return l||u||(p=r.createElement(ze,null,r.createElement(Ee,Te({item:t},i&&{handleToggle:d}),`${t.name} `))),p};Re.defaultProps={item:$e,sidebarToggle:null,collapseAll:!0},Re.defaultProps={opened:!1,hasActive:!1};const Be={opened:!0},Ne=e=>e.opened?"45deg":"0deg",Fe=j.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`;Fe.defaultProps=Be;const We=P("colors.sidebarBg"),qe=P("colors.sidebarPrimary"),Ue=P("colors.sidebarText"),Ge=P("colors.primary"),Ve=P("colors.background"),Ke=P("colors.text"),Je=j.d.span`
  ...
  &:nth-of-type(1) {
    top: -2px;
    transform: translateY(${e=>e.opened?"10px":"0px"}) rotate(${Ne});
  }
  ...
  &:nth-of-type(3) {
    top: 14px;
    transform: translateY(${e=>e.opened?"-6px":"0px"}) rotate(-${Ne});
  }
...
`,Mt=Object(j.d)(Lt)`
	background: transparent;
`;var _t=o("./node_modules/react-dropdown-select/lib/index.js"),Rt=o.n(_t);function Bt(){return(Bt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const Nt=e=>{let{options:t,...o}=e;const[n,a]=Object(r.useState)([{id:1,href:"/",title:"Latest",label:"Latest"}]),s=j.d.div`
    > div {
  ...
  `;return i.a.createElement(s,null,i.a.createElement(r.Fragment,null,i.a.createElement("label",null,"Versions:"),i.a.createElement(Rt.a,Bt({valueField:"id",placeholder:"Documentation",color:E,options:t,values:n,onChange:e=>{if(e.length>0&&n!==e){let t=e[0].href,o="_self";a(e),"Latest"!==e[0].title&&(t=`http://atlas.apache.org${e[0].href}`,o="_blank"),window.open(t,o)}}},o))))};Nt.propTypes={};var Ft=Nt;const Wt=j.d.div`
	width: 220px;
	padding: 0;
	margin-right: 5px;
	float: right;
`,qt=()=>{const{config:e}=Object(r.useContext)(u.doczState.context),{atlasVersions:t}=e;return i.a.createElement(Wt,null,i.a.createElement(Ft,{options:t,style:{minHeight:"auto",padding:"0 5px",borderRadius:"5px"}}))},Ut=j.d.div`
  width: 100%;
  height: auto;
  padding: 0;
  position: fixed;
...
`;var Gt=e=>r.createElement(Ut,null,r.createElement(W,e),r.createElement(qt,null));const Vt=j.d.div`
  flex: 1;
  color: ${P("colors.text")};
  background: ${P("colors.background")};
  min-width: 0;
...
`,Kt=j.d.div`
  ...
  ${P("styles.container")};
`,Jt=Object(j.d)(Mt.withComponent("a"))`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
...
`,no=Object(j.d)(to)`
  ...
  background: transparent;
  opacity: 0.5;
`,ao=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(u.useComponents)(),a=Object(r.useMemo)(()=>Object(j.d)(n.P||"p")`
      font-size: 16px;
      color: ${P("colors.sidebarText")};
    `,[]);return r.createElement(r.Fragment,null,o.map(([e,o])=>o.type||o.flowType?r.createElement(Xt,{key:e},r.createElement(Yt,null,r.createElement(eo,null,e),r.createElement(to,null,t(o)),o.defaultValue&&r.createElement(oo,null,"''"===o.defaultValue.value?r.createElement("em",null,"= [Empty String]"):r.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&r.createElement(no,null,r.createElement("em",null,"required"))),o.description&&r.createElement(a,null,o.description)):null))},ro=j.d.div`
  border: 1px solid ${P("colors.border")};
  border-radius: 4px;
  overflow: hidden;
  background: ${P("colors.propsBg")};
...
`,fo=j.d.span`
  font-size: 0.8em;
  opacity: 0.8;
`,vo=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(u.useComponents)(),a=Object(r.useMemo)(()=>Object(j.d)(n.P||"p")`
      margin: 0;
      font-size: 16px;
      color: ${P("colors.blockquoteColor")};
      padding: 0 15px 8px 15px;
    `,[]);return r.createElement(ro,null,o.map(([e,o])=>o.type||o.flowType?r.createElement(io,{key:e},r.createElement(po,null,r.createElement(lo,null,r.createElement(mo,null,e)),r.createElement(uo,null,r.createElement(ho,null,t(o))),r.createElement(co,null,o.defaultValue&&r.createElement(go,null,"''"===o.defaultValue.value?r.createElement("em",null,"= [Empty String]"):r.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&r.createElement(fo,null,r.createElement("strong",null,"required")))),o.description&&r.createElement(a,null,o.description)):null))},bo=j.d.div`
  margin: 20px 0;
`,yo=j.d.div`
  overflow-x: auto;
  padding: 2px;
...
`,xo=j.d.table`
  ...
  ${P("styles.table")};
`,ko={a:({href:e,...t})=>{const{separator:o,linkComponent:n}=Object(u.useConfig)(),a=Object(u.useDocs)(),i=Object(r.useMemo)(()=>((e,t)=>"undefined"===typeof window?null:[location.pathname.split(e).slice(0,-1).join(e).slice(1),(t||"").replace(/^(?:\.\/)+/gi,"")].join("/"))(o,e),[o,e]),s=a&&a.find(e=>e.filepath===i),l=s?s.route:e;return l&&l.startsWith("/")?r.createElement($,T({as:n},t,{to:l})):r.createElement($,T({},t,{href:l}))},blockquote:D,inlineCode:H,loading:()=>r.createElement(z,null,r.createElement(B,null)),notFound:()=>r.createElement(Pt,null,r.createElement(jt,null),r.createElement(Ot,null,r.createElement(Dt,null,"Page Not Found"),r.createElement(Ht,null,"Check if you changed the document route or deleted it!"))),ol:Tt,p:Zt,page:({children:e,doc:{link:t,fullpage:o,edit:n=!1}})=>{const{repository:a}=Object(u.useConfig)(),{props:i}=e,s=Se.pagesForGithubLink.toString().includes(i.doc.name),l=r.createElement(r.Fragment,null,t&&n&&r.createElement(Jt,{href:t,target:"_blank"},r.createElement(Qt,{width:14})," Edit page"),r.createElement(Gt,{showGithubLink:s}),e);return r.createElement(Pt,null,a&&r.createElement(W,{repository:a}),!o&&r.createElement(jt,null),r.createElement(Vt,null,o?l:r.createElement(Kt,null,l)))},pre:()=>r.createElement("div",null),props:({title:e,isRaw:t,isToggle:o,...n})=>{const[a,i]=Object(r.useState)(!0),s=Object(u.useComponents)(),l=Object(r.useMemo)(()=>Object(j.d)(s.H3||"h3")`
      padding: 8px 0;
      position: relative;
      ${t?"":"margin-bottom: 0;"}
    ...
    `,[a]),d=o?{onClick:()=>i(e=>!e),onkeydown:()=>i(e=>!e),role:"button",tabindex:0}:{};return r.createElement(bo,null,(!!e||o)&&r.createElement(l,d,e||"Component props"),a&&r.createElement("div",null,t?r.createElement(ao,n):r.createElement(vo,n)))},table:e=>r.createElement(yo,null,r.createElement(xo,e)),ul:j.d.ul`
  list-style: none;
...
`,Ao={colors:n,styles:{body:j.c`
  ...
  `,blockquote:j.c`
    ...
    font-style: italic;
    font-size: 16px;
  `},fonts:{display:'"Source Sans Pro", sans-serif',mono:'"Inconsolata", monospace',ui:'"Source Sans Pro", sans-serif'},radii:"2px",mode:"light",showPlaygroundEditor:!1,linesToScrollEditor:18},Eo=(P("colors.sidebarBg"),P("colors.sidebarText","#13161F"),j.d.a`
	&,
	&:visited,
	&:active {
		text-decoration: none;
